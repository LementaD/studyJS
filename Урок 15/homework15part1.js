...
// я хз ???????????????????????????????????????????????????????
{
let hips = prompt("Введіть обхват стегон (см)")
  if (hips<88.999) {alert("XXS")}
  if (hips = 89) {alert("XS")}
  if (hips = 90) {alert("XS")}
  if (hips = 91) {alert("XS")}
  if (hips = 92) {alert("XS")}
  ...
  if (hips = 95) {alert("XS")}
  if (hips = 96) {alert("XS")}
  if (hips = [97, 98, 99, 101]) {alert("S")}
  if (102<hips<104.999) {alert("M")}
  if (105<hips<108.999) {alert("L")}
  if (109<hips<112.999) {alert("XL")}
  if (hips = 113-117) {alert("XXL")}
  if (hips>117.001)  {alert("XXXL")}
}
